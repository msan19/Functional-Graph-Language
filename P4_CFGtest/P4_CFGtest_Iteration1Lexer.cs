...
namespace P4CfgtestIteration1
{
	/// <summary>
	/// Represents a lexer
	/// </summary>
	[GeneratedCodeAttribute("Hime.SDK", "3.5.1.0")]
	internal class P4_CFGtest_Iteration1Lexer : ContextFreeLexer
	{
		/// <summary>
		/// The automaton for this lexer
		/// </summary>
		private static readonly Automaton commonAutomaton = Automaton.Find(typeof(P4_CFGtest_Iteration1Lexer), "P4_CFGtest_Iteration1Lexer.bin");
		/// <summary>
		...
		public P4_CFGtest_Iteration1Lexer(string input) : base(commonAutomaton, terminals, 0x0007, input) {}
		/// <summary>
		/// Initializes a new instance of the lexer
		/// </summary>
		/// <param name="input">The lexer's input</param>
		public P4_CFGtest_Iteration1Lexer(TextReader input) : base(commonAutomaton, terminals, 0x0007, input) {}
	}
}
