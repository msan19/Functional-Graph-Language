...
namespace P4CfgtestIteration1
{
	...
	internal class P4_CFGtest_Iteration1Parser : LRkParser
	{
		/// <summary>
		/// The automaton for this parser
		/// </summary>
		private static readonly LRkAutomaton commonAutomaton = LRkAutomaton.Find(typeof(P4_CFGtest_Iteration1Parser), "P4_CFGtest_Iteration1Parser.bin");
		/// <summary>
		...
		public P4_CFGtest_Iteration1Parser(P4_CFGtest_Iteration1Lexer lexer) : base (commonAutomaton, variables, virtuals, null, lexer) { }
